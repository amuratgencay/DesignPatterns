...
using System.Linq;
using DesignPattern.Entity.CreationalPatterns.PrototypePattern;

namespace DesignPattern.BLL.CreationalPatterns.PrototypePattern
{
    public static class FibonacciCache
    {
        private static readonly Dictionary<int, FibonacciNumber> _fibonacciCache =
            new Dictionary<int, FibonacciNumber>();
